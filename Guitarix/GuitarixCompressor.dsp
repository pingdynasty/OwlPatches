...
ratio		= nentry("Ratio[OWL:PARAMETER_A]", 2, 1, 20, 0.1);
threshold	= nentry("Threshold[OWL:PARAMETER_B]", -20, -96, 10, 0.1);
knee		= nentry("Knee", 3, 0, 20, 0.1);

// attack and release controls; clamped to a minimum of 1 sample
attack		= hslider("Attack[OWL:PARAMETER_C]", 0.002, 0, 1, 0.001) : max(1/SR);
