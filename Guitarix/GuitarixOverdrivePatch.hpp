...
#ifndef __GuitarixOverdrivePatch_h__
#define __GuitarixOverdrivePatch_h__
...
/**************************************************************************************
	...
	GuitarixOverdrivePatch : an OWL patch that calls Faust generated DSP code
	
***************************************************************************************/

class GuitarixOverdrivePatch : public Patch
{
    GuitarixOverdrive   fDSP;
    OwlUI	fUI;
    
public:

    GuitarixOverdrivePatch() : fUI(patches.getCurrentPatchProcessor())
    {
...
#endif // __GuitarixOverdrivePatch_h__
