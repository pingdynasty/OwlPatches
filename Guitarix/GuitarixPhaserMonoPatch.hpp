...
class GuitarixPhaserMono : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("Feedback Gain", &fslider2, 0.0f, 0.0f, 1.0f, 0.01f);
		interface->declare(&fslider3, "OWL", "PARAMETER_A");
		interface->declare(&fslider3, "style", "knob");
		interface->declare(&fslider3, "unit", "Hz");
		interface->addHorizontalSlider("Speed", &fslider3, 0.5f, 0.0f, 5.0f, 0.005f);
		interface->declare(&fslider1, "OWL", "PARAMETER_D");
		interface->declare(&fslider1, "name", "wet/dry");
		interface->declare(&fslider1, "style", "knob");
		interface->declare(&fslider1, "tooltip", "percentage of processed signal in output signal");
		interface->addVerticalSlider("dry/wet", &fslider1, 1e+02f, 0.0f, 1e+02f, 1.0f);
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		float 	fSlow0 = (0.5f * float(fslider0));
		float 	fSlow1 = float(fslider1);
		float 	fSlow2 = (0.01f * fSlow1);
		float 	fSlow3 = ((1 - fSlow2) + (0.01f * (fSlow1 * (1 - fSlow0))));
		float 	fSlow4 = float(fslider2);
		float 	fSlow5 = (fConst3 * float(fslider3));
		float 	fSlow6 = cosf(fSlow5);
		float 	fSlow7 = sinf(fSlow5);
		float 	fSlow8 = (0 - fSlow7);
		float 	fSlow9 = (0 - fSlow0);
		FAUSTFLOAT* input0 = input[0];
		FAUSTFLOAT* output0 = output[0];
		for (int i=0; i<count; i++) {
			float fTemp0 = (float)input0[i];
			iVec0[0] = 1;
			fRec5[0] = ((fSlow7 * fRec6[1]) + (fSlow6 * fRec5[1]));
			fRec6[0] = ((1 + ((fSlow6 * fRec6[1]) + (fSlow8 * fRec5[1]))) - iVec0[1]);
			float fTemp1 = (628.3185307179587f + (2199.1148575128555f * (1 - fRec5[0])));
			float fTemp2 = (fRec4[1] * cosf((fConst4 * fTemp1)));
			fRec4[0] = (0 - (((fConst5 * fTemp2) + (fConst2 * fRec4[2])) - ((fSlow2 * fTemp0) + (fSlow4 * fRec0[1]))));
			...
			output0[i] = (FAUSTFLOAT)((fSlow9 * fRec0[0]) + (fSlow3 * fTemp0));
			// post processing
			fRec0[1] = fRec0[0];
...
public:
    ...
    GuitarixPhaserMonoPatch() : fUI(this)
    {
