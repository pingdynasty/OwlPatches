...
#ifndef __LPFPatch_h__
#define __LPFPatch_h__
...
/**************************************************************************************
	...
	LPFPatch : an OWL patch that calls Faust generated DSP code
	
***************************************************************************************/

class LPFPatch : public Patch
{
    LPF   fDSP;
    OwlUI	fUI;
...
public:
    ...
    LPFPatch() : fUI(patches.getCurrentPatchProcessor())
    {
