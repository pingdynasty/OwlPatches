...
#ifndef __AutoWahPatch_h__
#define __AutoWahPatch_h__
...
class AutoWah : public dsp {
  ...
  public:
	...
	virtual void instanceInit(int samplingFreq) {
		...
		fConst4 = (2827.43f / float(iConst0));
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("Gain", &fHslider0, 1.f, 0.f, 2.f, 0.0001f);
		interface->declare(&fHslider1, "OWL", "PARAMETER_E");
		interface->addHorizontalSlider("Super Wah", &fHslider1, 0.f, 0.f, 0.8f, 0.0001f);
		interface->declare(&fHslider2, "OWL", "PARAMETER_D");
		interface->addHorizontalSlider("Wah", &fHslider2, 0.6f, 0.f, 1.f, 0.0001f);
		interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (float(fHslider1) + float(fHslider2));
		float fSlow2 = (0.f - (fSlow1 - 1.f));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			float fTemp1 = fabsf(fTemp0);
			fRec2[0] = max(fTemp1, ((fConst2 * fRec2[1]) + (fConst3 * fTemp1)));
			float fTemp2 = powf(2.f, (2.3f * fRec2[0]));
			float fTemp3 = (1.f - (fConst1 * (fTemp2 / powf(2.f, (1.f + (2.f * (1.f - fRec2[0])))))));
			fRec1[0] = ((0.999f * fRec1[1]) + (0.001f * (0.f - (2.f * (fTemp3 * cosf((fConst4 * fTemp2)))))));
			fRec3[0] = ((0.999f * fRec3[1]) + (0.001f * faustpower2_f(fTemp3)));
			fRec4[0] = ((0.999f * fRec4[1]) + (0.0001f * powf(4.f, fRec2[0])));
			fRec0[0] = (0.f - (((fRec1[0] * fRec0[1]) + (fRec3[0] * fRec0[2])) - (fRec4[0] * fTemp0)));
			output0[i] = FAUSTFLOAT((fSlow0 * ((fSlow1 * (fRec0[0] - fRec0[1])) + (fSlow2 * fTemp0))));
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
...
/**************************************************************************************
	...
	AutoWahPatch : an OWL patch that calls Faust generated DSP code
