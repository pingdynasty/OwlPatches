...
#ifndef __phaserPatch_h__
#define __phaserPatch_h__
...
class phaser : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		interface->openVerticalBox("phaser");
...
/**************************************************************************************
	...
	phaserPatch : an OWL patch that calls Faust generated DSP code
...
public:
    ...
    phaserPatch() : fUI(patches.getCurrentPatchProcessor())
    {
