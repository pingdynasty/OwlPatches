...
#ifndef __PitchShifterPatch_h__
#define __PitchShifterPatch_h__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS PitchShifter
#endif
...
/**************************************************************************************
	...
	PitchShifterPatch : an OWL patch that calls Faust generated DSP code
	
***************************************************************************************/

class PitchShifterPatch : public Patch
{
    PitchShifter   fDSP;
    OwlUI	fUI;
...
public:
    ...
    PitchShifterPatch() : fUI(patches.getCurrentPatchProcessor())
    {
